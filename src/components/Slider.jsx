  ...
  return (
    <div className=''>
      <div className="relative py-20" data-carousel="slide">
        ...
        <button
          type="button"
          className="absolute top-0 left-0 z-50 flex items-center justify-center h-full px-4 cursor-pointer group focus:outline-none"
        ...
        <button
          type="button"
          className="absolute top-0 right-0 z-50 flex items-center justify-center h-full px-4 cursor-pointer group focus:outline-none"
